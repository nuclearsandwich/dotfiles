...
append_path /usr/lib/plan9/bin
append_path $HOME/.npm-packages/node_modules/.bin
...
export BROWSER EDITOR VISUAL PAGER HGEDITOR _JAVA_OPTIONS _JAVA_AWT_WM_NONREPARENTING
